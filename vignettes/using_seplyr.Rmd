...
We can also use `gsub` or the `glue` package for the same effect:
...
For more details please also see: [`help(`:=`, package = 'wrapr')`](https://winvector.github.io/wrapr/reference/named_map_builder.html) and 
