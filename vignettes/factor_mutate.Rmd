...
My personal opinion is: [no it is not](http://www.win-vector.com/blog/2017/09/my-advice-on-dplyrmutate/).
...
However "in memory" is not the only place `dplyr` is used and promoted.
